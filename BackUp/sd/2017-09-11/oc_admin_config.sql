...
INSERT INTO `oc_admin_config` VALUES ('12', '后台多标签', 'ADMIN_TABS', '1', '2', 'radio', '0:关闭
...
INSERT INTO `oc_admin_config` VALUES ('14', '后台主题', 'ADMIN_THEME', 'default', '2', 'select', 'default:默认主题
blue:蓝色理想
green:绿色生活', '后台界面主题', '1436678171', '1436690570', '5', '1');
INSERT INTO `oc_admin_config` VALUES ('15', '导航分组', 'NAV_GROUP_LIST', 'main:主导航
top:顶部导航
bottom:底部导航
wap_bottom:Wap底部导航', '2', 'array', '', '导航分组', '1458382037', '1458382061', '6', '1');
INSERT INTO `oc_admin_config` VALUES ('16', '配置分组', 'CONFIG_GROUP_LIST', '1:基本
2:系统
3:开发
4:部署
5:授权', '2', 'array', '', '配置分组', '1379228036', '1426930700', '7', '1');
INSERT INTO `oc_admin_config` VALUES ('17', '开发模式', 'DEVELOP_MODE', '1', '3', 'select', '1:开启
0:关闭', '开发模式下会显示菜单管理、配置管理、数据字典等开发者工具', '1432393583', '1432393583', '1', '1');
INSERT INTO `oc_admin_config` VALUES ('18', '是否显示页面Trace', 'SHOW_PAGE_TRACE', '1', '3', 'select', '0:关闭
1:开启', '是否显示页面Trace信息', '1387165685', '1387165685', '2', '1');
INSERT INTO `oc_admin_config` VALUES ('19', '系统加密KEY', 'AUTH_KEY', 'oQ[Kme<T{%x$ct&}Y!,WFgT_J>~!_u_?Ze{fL*&%F"BJ,*=p:bn}uYitbluJ"rd}', '3', 'textarea', '', '轻易不要修改此项，否则容易造成用户无法登录；如要修改，务必备份原key', '1438647773', '1438647815', '3', '1');
INSERT INTO `oc_admin_config` VALUES ('20', 'URL模式', 'URL_MODEL', '3', '4', 'select', '0:普通模式
1:PATHINFO模式
2:REWRITE模式
...
INSERT INTO `oc_admin_config` VALUES ('22', '开启子域名配置', 'APP_SUB_DOMAIN_DEPLOY', '0', '4', 'radio', '1:是
...
INSERT INTO `oc_admin_config` VALUES ('25', '强制Wap主题', 'WAP_MODE', '0', '4', 'radio', '1:是
