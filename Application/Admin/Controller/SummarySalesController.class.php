 ...
 * @author jry <598821125@qq.com>
 */
class SummarySalesController extends AdminController
{
    /**
     * 列表
     * @author jry <598821125@qq.com>
    ...
    public function index()
    {
        ...
        $map['out_order_type_name'] = array('like', '%销售%'); // 禁用和正常状态


        $p             = !empty($_GET["p"]) ? $_GET['p'] : 1;
        $user_object   = D('storehouse_out_order');
...
//            ->addTableColumn('id', 'ID')
            ...
            ->addTableColumn('goods_out_unit_price', '单价')
            ->addTableColumn('goods_out_total_quantity', '数量')
            ->addTableColumn('goods_out_total_price', '金额')
