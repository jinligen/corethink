 ...
 * @author jry <598821125@qq.com>
 */
class PaymentWayController extends AdminController
{
    /**
     * 列表
     * @author jry <598821125@qq.com>
    ...
    public function index()
    {
        ...
        $builder->setMetaTitle('商品列表') // 设置页面标题
            ...
            ->addTableColumn('payment_way', '支付方式')
            ->addTableColumn('payment_account', '支付账户')
    ...
    public function add()
    {
        if (IS_POST) {
            ...
            $builder->setMetaTitle('新增') //设置页面标题
                ...
                ->addFormItem('payment_way', 'text', '支付方式', '','','','')
                ->addFormItem('payment_account', 'text', '支付账户', '','','','')
