    ...
    public function kuCunMingXiZhang()
    {
        ...
        if (IS_POST) {
            ...
            $field1 = '
                ...
                goods_weight AS goods_entry_weight,  
                goods_entry_unit_price AS goods_entry_unit_price,
                goods_entry_total_quantity AS goods_entry_total_quantity,
                goods_entry_total_price AS goods_entry_total_price, 
                
                \'\' AS goods_out_weight,  
                \'\' AS goods_out_unit_price,
                \'\' AS goods_out_total_quantity,
                \'\' AS goods_out_total_price,  
                
                \'\' AS goods_end_weight,  
                \'\' AS goods_end_unit_price,
                \'\' AS goods_end_total_quantity,
            ...
            $field2 = '
                ...
                \'\' AS goods_entry_weight,  
                \'\' AS goods_entry_unit_price,
                \'\' AS goods_entry_total_quantity,
                \'\' AS goods_entry_total_price,  
                
                goods_weight AS goods_out_weight,  
                goods_out_unit_price AS goods_out_unit_price,
                goods_out_total_quantity AS goods_out_total_quantity,
                goods_out_total_price AS goods_out_total_price, 
            ...
            $list = D('storehouse_entry_order ')
                ->field($field1)
                ->where($where1)
                ->union(array('field'=>$field2,'table'=>'oc_storehouse_out_order ','order'=>'order_date','where'=>$where2))
//                ->fetchSql(true)
                ->select() ;
//            echo $list;
//            exit;
            ...
            $field3 = "    
                      ...
                      '' AS order_date,
                      '' AS order_id,    
                      goods_min_unit AS goods_actual_unit,  
                      ...
                      goods_stock_balance AS goods_end_weight,  
                      goods_cost_price AS goods_end_unit_price,
    ...
    public function yingFuMingXiZhang()
    {
        ...
        if (IS_POST) {
            $field1 = '
                ...
                entry_order_before_payment      as order_before_payment,
            ...
            $field2 = '
                ...
                payment_order_actual_payment        as order_before_payment,
    ...
    public function yingShouMingXiZhang()
    {
        if (IS_POST) {
            $field1 = '
                ...
                out_order_id                    as order_id,  
                out_order_remark                as order_remark, 
                out_order_before_payment        as order_before_payment,
                out_order_account_receivable    as order_should_payment, 
                out_order_actual_payment        as order_actual_payment,
                \'\'                            as end_should_payment,
                department                      as department, 
            ...
            $field2 = '
                ...
                gathering_order_id                  as order_id,  
                gathering_order_remark              as order_remark, 
                gathering_order_actual_payment      as order_before_payment,
                gathering_order_receivable_price    as order_should_payment, 
                gathering_order_actual_payment      as order_actual_payment,
                \'\'                                as end_should_payment,
                department                          as department, 
